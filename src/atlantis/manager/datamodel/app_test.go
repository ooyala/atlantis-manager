...
func (s *DatamodelSuite) TestApp(c *C) {
	...
	app1, err = CreateOrUpdateApp(true, app, repo, root, "jigish@ooyala.com")
	c.Assert(err, IsNil)
	...
	app2, err := CreateOrUpdateApp(false, "oogabooga", repo, root, "jigish@ooyala.com")
	...
	c.Assert(app1.Email, Equals, "jigish@ooyala.com")
	c.Assert(app1.HasDepender("oogabooga"), Equals, true)
	app1, err = CreateOrUpdateApp(false, app, repo+"2", root+"2", "oogabooga@ooyala.com")
	c.Assert(err, IsNil)
